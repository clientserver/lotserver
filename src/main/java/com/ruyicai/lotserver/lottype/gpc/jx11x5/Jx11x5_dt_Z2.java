 ...
 *
 */
public class Jx11x5_dt_Z2 {

	/**
	 * 解析OrderInfo
	 * @param code(Z2|11$09 01_2_200_400)
	 * @return
	 */
	...
	public static String parseOrderInfoHtml(String code, String winCode) {
		...
		List<String> winCodeList = LotteryAlgorithmUtil.getStringArrayFromString(winCode.substring(0, 4), 2); //前2位中奖号码
